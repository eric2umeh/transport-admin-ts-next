      ...
      <div className="footer__row row y-gap-10 items-center justify-between">
          ...
          <div className="row y-gap-20 items-center">
            <div className="col-auto">
              <div className="text-14 lh-14 mr-30">
                © {new Date().getFullYear()} tfare LLC All rights reserved.
              </div>
            </div>
        ...
        <div className="col-auto">
          <div className="d-flex x-gap-5 y-gap-5 items-center">
            <button className="text-14 fw-500 underline">tfaregroup@gmail.com</button>
            <button className="text-14 fw-500 underline">₦</button>
          </div>
        </div>
        {/* End .col-auto */}
      </div>
